    ...
    <section className="py-24 px-8" id="contact">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="space-y-6">
          <div className="flex gap-4 items-start"><div className="text-3xl">📍</div><div><h4 className="font-bold">门店地址</h4><p className="text-gray">北京市朝阳区建国路88号萌宠大厦1层</p></div></div>
          ...
          <div className="flex gap-4 items-start"><div className="text-3xl">🕐</div><div><h4 className="font-bold">营业时间</h4><p className="text-gray">周一至周日 9:00 - 21:00（节假日不休）</p></div></div>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <select required className="px-5 py-3 rounded-xl border-2 border-[#ECF0F1] focus:border-primary outline-none transition-colors bg-white">
              <option value="" disabled selected>选择服务套餐</option>
              <option>基础洗护 - ¥68起</option>
              <option>造型美容 - ¥128起</option>
