    ...
    <section className="py-24 px-8" id="contact">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray mb-2">期望到店时间</label>
            <input 
              type="datetime-local" 
              value={preferredTime}
              onChange={(e) => setPreferredTime(e.target.value)}
              className="w-full px-5 py-3 rounded-xl border-2 border-[#ECF0F1] focus:border-primary outline-none transition-colors" 
            />
          </div>
